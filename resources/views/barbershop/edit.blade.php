...
<div class="card">
    <div class="card-header">
        <h4 class="card-title">Edit Barbershop</h4>
    </div>
    <div class="card-body ml-3">
        {!! Form::model($barbershop, array('route' => array('barbershop.update', $barbershop->id), 'method' => 'PUT', 'enctype' => 'multipart/form-data')) !!}

        <div class="row">
            <div class="col-md-8 px-1">
                <div class="form-group">
                    <label for="name">Nama</label>
                    <input name="name" type="text" class="form-control" placeholder="L.A. Barbershop" value="{{$barbershop->name}}">
                </div>
            </div>
            <div class="col-md-4 pl-1">
                <div class="form-group">
                    <label for="email">E-Mail Barbershop</label>
                    <input name="email" type="email" class="form-control" placeholder="la.barbershop@gmail.com" value="{{$barbershop->email}}">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 px-1">
                <div class="form-group">
                    ...
                    <small class="text-muted">Provinsi Sebelumnya: {{ucwords(strtolower($barbershop->province->name))}}</small>
                </div>
            </div>
            <div class="col-md-4 px-1">
                <div class="form-group">
                    ...
                    <small class="text-muted">Kabupaten Sebelumnya: {{ucwords(strtolower($barbershop->regency->name))}}</small>
                </div>
            </div>
            <div class="col-md-4 pl-1">
                <div class="form-group">
                    ...
                    <small class="text-muted">Kecamatan Sebelumnya: {{ucwords(strtolower($barbershop->district->name))}}</small>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 pl-1">
                <div class="form-group">
                    ...
                    <textarea name="alamat" rows="3" class="form-control" 
                        placeholder="Jalan Kusbini No.35, Klitren, Gondokusuman, Klitren 55222" required>{{$barbershop->alamat}}</textarea>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-6 pl-1">
                <input name="longitude" type="text" class="form-control" placeholder="-7.2019482" value="{{$barbershop->longitude}}" required>
            </div>
            <div class="col-md-6 pl-1">
                <input name="latitude" type="text" class="form-control" placeholder="107.886734" value="{{$barbershop->latitude}}" required>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 pl-1">
                <div class="form-group">
                    ...
                    <small>Isi dengan Jam Buka, Harga Anak/Dewasa, Fasilitas Barbershop, dan deskripsi lainnya.</small>
                    <textarea name="deskripsi" id="article-ckeditor" class="form-control" required>{{$barbershop->deskripsi}}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-8 px-1">
                <div class="form-group">
                    ...
                    <input name="no_telp" type="text" class="form-control" placeholder="+6285-1234-5678" value="{{$barbershop->no_telp}}">
                </div>
                <div class="form-group">
                    <label for="facebook">Facebook Profile</label>
                    <textarea name="facebook" placeholder="https://www.facebook.com/YourAccountProfile" class="form-control" >{{$barbershop->facebook}}</textarea>
                </div>
                <div class="form-group">
                    <label for="alamat">Twitter Profile</label>
                    <textarea name="twitter" placeholder="https://twitter.com/YourAccountProfile"  class="form-control" >{{$barbershop->twitter}}</textarea>
                </div>
                <div class="form-group">
                    <label for="alamat">Instagram Profile</label>
                    <textarea name="instagram" placeholder="https://www.instagram.com/YourAccountProfile" class="form-control" >{{$barbershop->instagram}}</textarea>
                </div>
            </div>
            <div class="col-md-4 pl-1">
                <div class="form-group">
                    ...
                    <img src="{{asset('img/barbershop/'.$barbershop->gambar)}}" class="mt-3" width="50%">
                </div>
            </div>
        </div>
